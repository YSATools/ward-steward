...
// pakmanager:ward-steward-browser/lib/mock/dashboard-data
(function (context) {
    ...
    , "companions": [
        {
          ...
          "last": "Calrissian",
          "phone": "(555) 133-9760",
          "email": "lando_calrissian@msn.com"
        }
      ]
    , "homeTeachers": [
        {
          ...
          "last": "Dumbledore",
          "phone": "(555) 571-9859",
          "email": "Albus_Dumbledore@hotmail.com"
        },
        {
          "name": "Severus",
          "nick": "",
    ...
    , "visitingTeachers": [
        {
          ...
          "last": "Granger",
          "phone": "(555) 940-0112",
          "email": "hermione_granger@msn.com"
        },
        {
          "name": "Ginny",
          "nick": "",
    ...
    , "stewardship": [
        {
          ...
          "last": "Black",
          "phone": "(893) 555-9935",
          "email": "sirius_black@comcast.net"
        },
        {
          "name": "Neville",
          "nick": "",
          "last": "Longbottom",
          "phone": "(589) 555-0091",
          "email": "Neville.Longbottom@msn.com"
        },
        {
          "name": "Alastor",
          "nick": "Mad-Eye",
...
(function (context) {
  ...
  (function () {
      ...
      var $p = require('pure').$p
        , data =  require('ward-steward-browser/lib/mock/dashboard-data')
        , tpls = {}
        ;
  ...
  provide("ward-steward-browser/lib/dashboard", module.exports);
}(global));

// pakmanager:ward-steward-browser
(function (context) {
